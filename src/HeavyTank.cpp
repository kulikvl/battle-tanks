...
HeavyTank::HeavyTank(const MazeSolver& mazeSolver, Player& player) :
    Tank(mazeSolver, Sprite("assets/Tanks.png", 2, true), Config::getFloat("heavytank_velocity", 2.5f), Config::getInt("heavytank_hp", 6), player )
{
    selectPath();
}
